...
# sample mopdels with NUTS, 4 multi-threaded parallel chains, and 2k iters
chn_poisson = sample(model_poisson, NUTS(), MCMCThreads(), 2_000, 4)
chn_negative_binomial = sample(model_negative_binomial, NUTS(), MCMCThreads(), 2_000, 4)
